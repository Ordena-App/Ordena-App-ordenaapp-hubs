 ...
 */
const driverSettlementLineSchema = new mongoose_1.Schema({
    orderId: { type: String },
...
const driverSettlementAdjustmentSchema = new mongoose_1.Schema({
...
const hubDriverSettlementSchema = new mongoose_1.Schema({
...
exports.default = (0, mongoose_1.model)("hub_driver_settlements", hubDriverSettlementSchema);
